...
export const poolDetailsMap: Record<string, PoolDetails> = {
  ...
  [conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_POOL]: {
    ...
    poolId: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_POOL,
    investorId: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_INVESTOR,
    receipt: {
      name: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_RECEIPT_NAME,
      type: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_RECEIPT,
    },
    assetTypes: [coinsList['SUIUSDT'].type, coinsList['USDC'].type],
    events: {
      autoCompoundingEventType: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_AUTO_COMPOUNDING_EVENT,
      rebalanceEventType: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_POOL_REBALANCE_EVENT,
      liquidityChangeEventType: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_POOL_LIQUIDITY_CHANGE_EVENT,
    },
    retired: false,
  },
  ...
  [conf[CONF_ENV].ALPHA_SLUSH_SUI_POOL_ID]: {
    ...
    parentProtocolName: 'ALPHALEND',
    parentPoolId: '',
    poolId: conf[CONF_ENV].ALPHA_SLUSH_SUI_POOL_ID,
    investorId: conf[CONF_ENV].ALPHAFI_SLUSH_SUI_INVESTOR,
    receipt: {
      name: '',
      type: '',
    },
  ...
  [conf[CONF_ENV].ALPHA_SLUSH_USDC_POOL_ID]: {
    poolName: 'ALPHALEND-SLUSH-USDC',
    packageId: conf[CONF_ENV].ALPHA_SLUSH_LATEST_PACKAGE_ID,
    packageNumber: 12,
    parentProtocolName: 'ALPHALEND',
    parentPoolId: '',
    poolId: conf[CONF_ENV].ALPHA_SLUSH_USDC_POOL_ID,
    investorId: conf[CONF_ENV].ALPHAFI_SLUSH_USDC_INVESTOR,
    receipt: {
      name: '',
      type: '',
    },
  ...
  [conf[CONF_ENV].ALPHA_SLUSH_WAL_POOL_ID]: {
    poolName: 'ALPHALEND-SLUSH-WAL',
    packageId: conf[CONF_ENV].ALPHA_SLUSH_LATEST_PACKAGE_ID,
    packageNumber: 12,
    parentProtocolName: 'ALPHALEND',
    parentPoolId: '',
    poolId: conf[CONF_ENV].ALPHA_SLUSH_WAL_POOL_ID,
    investorId: conf[CONF_ENV].ALPHAFI_SLUSH_WAL_INVESTOR,
    receipt: {
      name: '',
      type: '',
    },
  ...
  [conf[CONF_ENV].ALPHA_SLUSH_DEEP_POOL_ID]: {
    poolName: 'ALPHALEND-SLUSH-DEEP',
    packageId: conf[CONF_ENV].ALPHA_SLUSH_LATEST_PACKAGE_ID,
    packageNumber: 12,
    parentProtocolName: 'ALPHALEND',
    parentPoolId: '',
    poolId: conf[CONF_ENV].ALPHA_SLUSH_DEEP_POOL_ID,
    investorId: conf[CONF_ENV].ALPHAFI_SLUSH_DEEP_INVESTOR,
    receipt: {
      name: '',
      type: '',
    },
