...
export class Blockchain {
   ...
   * wallet's dapp-kit client). SUI resolves from the gas coin automatically
   * (`coinWithBalance` defaults to `useGasCoin: true` and normalizes the type),
   * so no SUI special-case is needed here.
   */
