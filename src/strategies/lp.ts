  ...
  parsePoolObject(response: any): LpPoolObject {
    return this.safeParseObject(() => {
      ...
      return {
        ...
        rewards: {
          coinType:
            this.getStringField(fields, 'coinType') || this.getStringField(fields, 'coin_type'),
          amount: this.getStringField(fields, 'amount'),
          apr: this.getStringField(fields, 'apr'),
        },
  ...
  parseInvestorObject(response: any): LpInvestorObject {
    return this.safeParseObject(() => {
      ...
      return {
        ...
        free_rewards: {
          id: this.getStringField(fields, 'id'),
          size: this.getStringField(fields, 'size'),
        },
        id: this.getStringField(fields, 'id'),
...
/**
 * Event types configuration for LP strategy
 */
export interface LpEventTypes {
