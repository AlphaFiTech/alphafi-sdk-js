...
> {
  ...
  async rebalanceLp(
    ...
    if (poolName === 'BLUEFIN-SUI-USDC') {
      ...
      const cetusUsdcSuibtc = await context.getPoolIdBySymbolsAndProtocol(
        'USDC',
        'SUIBTC',
        'cetus',
      );
      ...
      const bluefinSuiSuibtc = await context.getPoolIdBySymbolsAndProtocol(
        'SUI',
        'SUIBTC',
        'bluefin',
      );
